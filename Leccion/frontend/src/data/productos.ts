...
// Mock de datos del catálogo de cosméticos
// En Unidad 2 se reemplazarán con llamadas reales a PostgreSQL
...
export interface Producto {
  ...
  galeria: string[];  // Imágenes para lightbox
}
...
export const productosMock: Producto[] = [
  ...
  },
  {
    ...
    descripcion:
      "Set de 5 productos: limpiador, tónico, serum, crema y mascarilla. Todo lo que necesitas para una rutina efectiva y completa.",
    precio: 120.0,
    categoria: "Kit",
